...
function unternehmerinnen_zentrum_preprocess_html(&$variables) {
 ...
 * @param $variables
 */
function unternehmerinnen_zentrum_preprocess_block(&$variables) {
 ...
 * @param $variables
 */
function unternehmerinnen_zentrum_preprocess_page(&$variables) {
  $variables['page']['content']['#attached']['js'][] = array(
    'type' => 'file',
    'data' => drupal_get_path('theme', 'unternehmerinnen_zentrum') . '/js/tz_scripts.js',
    'weight' => 2
  );
}
