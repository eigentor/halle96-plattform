...
if($plugin->view->name == 'conference_room_paid_1' && $plugin->view->current_display = 'page_1') {
  ...
  $booking_description = '<div class="booking-description">Eine Stornierung für die kostenpflichtigen Konferenzräume ist nur über die Zentrumsleitung/Vertretung möglich. <br />
